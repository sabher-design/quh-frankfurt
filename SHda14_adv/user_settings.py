...
class Constants(BaseConstants):
    ...
    #       val14_t2 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val14_t3 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val14_t4 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       ...

    # prio14 OF RESOURCES OVER PARTICIPANTS =================================================== #
    #   Since this app models only the proposing side as active players, the prio14 of the      #
    ...
    # SHOW RESOURCES' prio14 ================================================================== #
    #   Should a player see the resources' prio14 for her in the instructions and on the        #
    #   decision page?                                                                              #
    show_prio14 = False
    ...
    val14_list = ["val14_t" + str(i) for i in range(1, 11)]
    val14_raw = []
    for i in val14_list:
        if i in locals():
            val14_raw.append(locals()[i])

    val14 = []
    for i in val14_raw:
        val14.append([j for j in i if j is not None])

    prio14_list = ["prio14_r" + str(i) for i in range(1, 11)]
    prio14_raw = []
    for i in prio14_list:
        if i in locals():
            prio14_raw.append(locals()[i])

    prio14 = []
    for i in prio14_raw:
        prio14.append([j for j in i if j is not None])

    nr_types = len(val14)

    name_in_url = "SHda14_adv"
    num_rounds = 1
