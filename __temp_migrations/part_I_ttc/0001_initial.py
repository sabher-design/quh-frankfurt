    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctrq1_ttc', otree.db.models.IntegerField(null=True, verbose_name='1. Wie viele Schüler:innen bewerben sich für einen Schulplatz?')),
                ('ctrq2_ttc', otree.db.models.IntegerField(null=True, verbose_name='2. Sobald alle Schüler:innen an einer Schule zugelassen wurden, wie viele Plätze bleiben übrig?')),
