...
# =========================================================================================== #
print(f"val20 SHttc20_adv: {Constants.val20}")
print(f"prio20 SHttc20_adv: {Constants.prio20}")
...
def vars_for_all_templates(self):
    return {
        ...
        'val20': self.participant.vars['val20'],
        'val20_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['val20_others']),
        'prio20': self.participant.vars['prio20'],
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        success20 = [i for i in self.participant.vars['success20']]
