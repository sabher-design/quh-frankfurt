...
# =========================================================================================== #
print(f"val18 SHttc18_adv: {Constants.val18}")
print(f"prio18 SHttc18_adv: {Constants.prio18}")
...
def vars_for_all_templates(self):
    return {
        ...
        'val18': self.participant.vars['val18'],
        'val18_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['val18_others']),
        'prio18': self.participant.vars['prio18'],
...
class Results(Page):
    ...
    def before_next_page(self):
        ...
        self.participant.vars['SHttc18_adv_payoff'] = "{:.0f}".format(base_payoff)
        self.participant.vars['SHttc18_adv_payoff_half'] = "{:.2f}".format(half_payoff)
        self.participant.vars['SHttc18_adv_payoff_final'] = "{:.2f}".format(final_payoff)


    def vars_for_template(self):
        player_prefs = [i[0] for i in self.participant.vars['player_prefs']]
        success18 = [i for i in self.participant.vars['success18']]
