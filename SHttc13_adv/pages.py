...
# =========================================================================================== #
print(f"val13 SHttc13_adv: {Constants.val13}")
print(f"prio13 SHttc13_adv: {Constants.prio13}")
...
def vars_for_all_templates(self):
    return {
        ...
        'val13': self.participant.vars['val13'],
        'val13_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['val13_others']),
        'prio13': self.participant.vars['prio13'],
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        success13 = [i for i in self.participant.vars['success13']]
