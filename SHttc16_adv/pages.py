...
# =========================================================================================== #
print(f"val16 SHttc16_adv: {Constants.val16}")
print(f"prio16 SHttc16_adv: {Constants.prio16}")
...
def vars_for_all_templates(self):
    return {
        ...
        'val16': self.participant.vars['val16'],
        'val16_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['val16_others']),
        'prio16': self.participant.vars['prio16'],
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        success16 = [i for i in self.participant.vars['success16']]
