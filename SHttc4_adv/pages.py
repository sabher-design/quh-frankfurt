...
# =========================================================================================== #
print(f"val4 SHttc4_adv: {Constants.val4}")
print(f"prio4 SHttc4_adv: {Constants.prio4}")
...
def vars_for_all_templates(self):
    return {
        ...
        'val4': self.participant.vars['val4'],
        'val4_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['val4_others']),
        'prio4': self.participant.vars['prio4'],
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        success4 = [i for i in self.participant.vars['success4']]
