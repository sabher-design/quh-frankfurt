...
class Constants(BaseConstants):
    name_in_url = 'part_II_survey_ttc_adv2'
...
class Player(BasePlayer):
    ...
    crt_bat = models.DecimalField(max_digits=10, decimal_places=2, label='Ein Schläger und ein Ball kosten insgesamt 1,10 €. Der Schläger kostet 1 € mehr als der Ball. Wie viel kostet der Ball?')
    crt_widget = models.DecimalField(max_digits=10, decimal_places=2, label='Wenn 5 Maschinen 5 Minuten brauchen um 5 Produkte herzustellen, wie lange benötigen dann 100 Maschinen, um 100 Produkte herzustellen?')
    crt_lake = models.DecimalField(max_digits=10, decimal_places=2, label='In einem See wachsen Seerosen, die sich jeden Tag verdoppeln. Wenn es 48 Tage dauert, bis der ganze See bedeckt ist, wie lange dauert es, bis die Seerosen die Hälfte des Sees bedecken?')
