...
# =========================================================================================== #
print(f"val5 SHttc5_adv: {Constants.val5}")
print(f"prio5 SHttc5_adv: {Constants.prio5}")
...
def vars_for_all_templates(self):
    return {
        ...
        'val5': self.participant.vars['val5'],
        'val5_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['val5_others']),
        'prio5': self.participant.vars['prio5'],
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        success5 = [i for i in self.participant.vars['success5']]
