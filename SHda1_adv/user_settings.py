...
class Constants(BaseConstants):
    ...
    #       val1_t2 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val1_t3 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    ...
    val1_list = ["val1_t" + str(i) for i in range(1, 11)]
    val1_raw = []
    for i in val1_list:
        if i in locals():
            val1_raw.append(locals()[i])
