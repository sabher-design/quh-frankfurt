...
# =========================================================================================== #
print(f"val14 SHttc14_adv: {Constants.val14}")
print(f"prio14 SHttc14_adv: {Constants.prio14}")
...
def vars_for_all_templates(self):
    return {
        ...
        'val14': self.participant.vars['val14'],
        'val14_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['val14_others']),
        'prio14': self.participant.vars['prio14'],
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        success14 = [i for i in self.participant.vars['success14']]
