...
class Constants(BaseConstants):
    ...
    #       val4_t2 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val4_t3 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val4_t4 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       ...

    # prio4 OF RESOURCES OVER PARTICIPANTS =================================================== #
    #   Since this app models only the proposing side as active players, the prio4 of the      #
    ...
    # SHOW RESOURCES' prio4 ================================================================== #
    #   Should a player see the resources' prio4 for her in the instructions and on the        #
    #   decision page?                                                                              #
    show_prio4 = False
    ...
    val4_list = ["val4_t" + str(i) for i in range(1, 11)]
    val4_raw = []
    for i in val4_list:
        if i in locals():
            val4_raw.append(locals()[i])

    val4 = []
    for i in val4_raw:
        val4.append([j for j in i if j is not None])

    prio4_list = ["prio4_r" + str(i) for i in range(1, 11)]
    prio4_raw = []
    for i in prio4_list:
        if i in locals():
            prio4_raw.append(locals()[i])

    prio4 = []
    for i in prio4_raw:
        prio4.append([j for j in i if j is not None])

    nr_types = len(val4)

    name_in_url = "SHda4_adv"
    num_rounds = 1
