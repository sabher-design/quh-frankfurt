...
from SHda4_adv.user_settings import *
...
class Subsession(BaseSubsession):
    ...
    def creating_session(self):
        ...
        print(f"Starting session for SHda4_adv {self.__class__.__name__}")
        ...
        # ALLOCATE THE CORRECT val4 VECTOR TO PLAYER (DEPENDING ON TYPE) ================== #
        # AND GET OTHER PLAYERS' val4 AND TYPES TO DISPLAY IF DESIRED                       #
...
class Group(BaseGroup):
    ...
    def get_allocation(self):
        ...
        while len(iterlist) > 0:
            ...
            # ITERATION PROCESS AFTER INITIALLY ASSIGNING TOP CHOICE RESOURCES IN PASS 0 ======== #
                ...
                if len(iterlist) > 0:
                    ...
                    # Sort and then trim the attendants list for each school based on prio4
                    for n in indices:
        ...
        # ASSIGN A RESOURCE TO EACH SUBJECT AND CREATE A DUMMY VARIABLE FOR success4 PREFS IN = #
        ...
        for p in players:
            for n in indices:
                if n in p.participant.vars['player_resource']:
                    p.payoff += p.participant.vars['val4'][n - 1]
                    p.participant.vars['success4'][n - 1] = True
