...
# =========================================================================================== #
print(f"val19 SHttc19_adv: {Constants.val19}")
print(f"prio19 SHttc19_adv: {Constants.prio19}")
...
def vars_for_all_templates(self):
    return {
        ...
        'val19': self.participant.vars['val19'],
        'val19_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['val19_others']),
        'prio19': self.participant.vars['prio19'],
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        success19 = [i for i in self.participant.vars['success19']]
