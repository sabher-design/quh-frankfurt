...
# =========================================================================================== #
print(f"val6 SHttc6_adv: {Constants.val6}")
print(f"prio6 SHttc6_adv: {Constants.prio6}")
...
def vars_for_all_templates(self):
    return {
        ...
        'val6': self.participant.vars['val6'],
        'val6_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['val6_others']),
        'prio6': self.participant.vars['prio6'],
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        success6 = [i for i in self.participant.vars['success6']]
