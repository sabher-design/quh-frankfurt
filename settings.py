...
SESSION_CONFIGS = [
    ...
    dict(
        ...
        app_sequence=['part_0_intro_ttc', 'part_I_ttc', 'SHttc11_adv', 'SHttc7_adv', 'SHttc1_adv', 'SHttc12_adv',
                      ...
                      'SHttc6_adv', 'SHttc2_adv', 'SHttc8_adv', 'part_II_survey_ttc_adv1']
    ),
    dict(
        ...
        'SHda4_adv', 'SHda10_adv', 'SHda16_adv', 'SHda18_adv', 'SHda6_adv', 'SHda2_adv', 'SHda8_adv', 'part_II_survey_da_adv1']
    ),
    dict(
        name='ttc_sequence2',
        ...
        'SHttc8', 'SHttc10', 'SHttc18', 'part_II_survey_ttc2']
    ),
    dict(
        name='da_sequence2',
        ...
        'SHda10', 'SHda18', 'part_II_survey_da2']
    ),
    dict(
        ...
        'SHttc18_adv', 'part_II_survey_ttc_adv2']
    ),
    dict(
        ...
        'SHda13_adv', 'SHda2_adv', 'SHda3_adv', 'SHda14_adv', 'SHda8_adv', 'SHda10_adv', 'SHda18_adv', 'part_II_survey_da_adv2']
    ),
    dict(
        name='ttc_sequence3',
        ...
        'SHttc17', 'SHttc1', 'SHttc6', 'part_II_survey_ttc3']
    ),
    dict(
        name='da_sequence3',
    ...
    dict(
        ...
        'SHda19_adv', 'SHda14_adv', 'SHda2_adv', 'SHda8_adv', 'SHda17_adv', 'SHda1_adv', 'SHda6_adv', 'part_II_survey_da_adv3']
    ),
    dict(
        name='ttc_sequence4',
        ...
        'SHttc3', 'SHttc4', 'SHttc6', 'SHttc17', 'part_II_survey_ttc4']
    ),
    dict(
        name='da_sequence4',
    ...
    dict(
        ...
        'SHttc13_adv', 'SHttc15_adv', 'SHttc20_adv', 'SHttc3_adv', 'SHttc4_adv', 'SHttc6_adv', 'SHttc17_adv', 'part_II_survey_ttc_adv4']
    ),
    dict(
        ...
        'SHda13_adv', 'SHda15_adv', 'SHda20_adv', 'SHda3_adv', 'SHda4_adv', 'SHda6_adv', 'SHda17_adv', 'part_II_survey_da_adv4']
    ),
    ...
    dict(
        ...
        'SHttc19', 'SHttc16', 'SHttc18', 'SHttc5', 'part_II_survey_ttc5']
    ),
    dict(
        name='da_sequence5',
        ...
        'SHda18', 'SHda5', 'part_II_survey_da5']
    ),
    dict(
    ...
    dict(
        ...
        'SHda7_adv', 'SHda15_adv', 'SHda14_adv', 'SHda19_adv', 'SHda16_adv', 'SHda18_adv', 'SHda5_adv', 'part_II_survey_da_adv5']
    )
]
