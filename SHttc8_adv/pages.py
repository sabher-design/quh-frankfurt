...
# =========================================================================================== #
print(f"val8 SHttc8_adv: {Constants.val8}")
print(f"prio8 SHttc8_adv: {Constants.prio8}")
...
class Results(Page):
    ...
    def before_next_page(self):
        ...
        self.participant.vars['SHttc8_adv_payoff'] = "{:.0f}".format(base_payoff)
        self.participant.vars['SHttc8_adv_payoff_half'] = "{:.2f}".format(half_payoff)
        self.participant.vars['SHttc8_adv_payoff_final'] = "{:.2f}".format(final_payoff)
