...
class Results(Page):
    ...
    def before_next_page(self):
        ...
        self.participant.vars['SHda8_adv_payoff'] = "{:.0f}".format(base_payoff)
        self.participant.vars['SHda8_adv_payoff_half'] = "{:.2f}".format(half_payoff)
        self.participant.vars['SHda8_adv_payoff_final'] = "{:.2f}".format(final_payoff)
