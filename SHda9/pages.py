...
class Results(Page):
    ...
    def before_next_page(self):
        ...
        self.participant.vars['SHda9_payoff'] = "{:.0f}".format(base_payoff)
        self.participant.vars['SHda9_payoff_half'] = "{:.2f}".format(half_payoff)
        self.participant.vars['SHda9_payoff_final'] = "{:.2f}".format(final_payoff)
