...
# =========================================================================================== #
print(f"val18 SHttc18: {Constants.val18}")
print(f"prio18 SHttc18: {Constants.prio18}")
...
class Results(Page):
    ...
    def before_next_page(self):
        ...
        self.participant.vars['SHttc18_payoff'] = "{:.0f}".format(base_payoff)
        self.participant.vars['SHttc18_payoff_half'] = "{:.2f}".format(half_payoff)
        self.participant.vars['SHttc18_payoff_final'] = "{:.2f}".format(final_payoff)
