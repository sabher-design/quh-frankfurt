...
class Constants(BaseConstants):
    ...
    #       val15_t2 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val15_t3 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val15_t4 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       ...

    # prio15 OF RESOURCES OVER PARTICIPANTS =================================================== #
    #   Since this app models only the proposing side as active players, the prio15 of the      #
    ...
    # SHOW RESOURCES' prio15 ================================================================== #
    #   Should a player see the resources' prio15 for her in the instructions and on the        #
    #   decision page?                                                                              #
    show_prio15 = False
    ...
    val15_list = ["val15_t" + str(i) for i in range(1, 11)]
    val15_raw = []
    for i in val15_list:
        if i in locals():
            val15_raw.append(locals()[i])

    val15 = []
    for i in val15_raw:
        val15.append([j for j in i if j is not None])

    prio15_list = ["prio15_r" + str(i) for i in range(1, 11)]
    prio15_raw = []
    for i in prio15_list:
        if i in locals():
            prio15_raw.append(locals()[i])

    prio15 = []
    for i in prio15_raw:
        prio15.append([j for j in i if j is not None])

    nr_types = len(val15)

    name_in_url = "SHda15_adv"
    num_rounds = 1
