...
class Constants(BaseConstants):
    ...
    #       val10_t2 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val10_t3 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val10_t4 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       ...

    # prio10 OF RESOURCES OVER PARTICIPANTS =================================================== #
    #   Since this app models only the proposing side as active players, the prio10 of the      #
    ...
    # SHOW RESOURCES' prio10 ================================================================== #
    #   Should a player see the resources' prio10 for her in the instructions and on the        #
    #   decision page?                                                                              #
    show_prio10 = False
    ...
    val10_list = ["val10_t" + str(i) for i in range(1, 11)]
    val10_raw = []
    for i in val10_list:
        if i in locals():
            val10_raw.append(locals()[i])

    val10 = []
    for i in val10_raw:
        val10.append([j for j in i if j is not None])

    prio10_list = ["prio10_r" + str(i) for i in range(1, 11)]
    prio10_raw = []
    for i in prio10_list:
        if i in locals():
            prio10_raw.append(locals()[i])

    prio10 = []
    for i in prio10_raw:
        prio10.append([j for j in i if j is not None])

    nr_types = len(val10)

    name_in_url = "SHda10_adv"
    num_rounds = 1
