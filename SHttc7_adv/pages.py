...
# =========================================================================================== #
print(f"val7 SHttc7_adv: {Constants.val7}")
print(f"prio7 SHttc7_adv: {Constants.prio7}")
...
def vars_for_all_templates(self):
    return {
        ...
        'val7': self.participant.vars['val7'],
        'val7_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['val7_others']),
        'prio7': self.participant.vars['prio7'],
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        success7 = [i for i in self.participant.vars['success7']]
