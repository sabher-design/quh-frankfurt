...
class Constants(BaseConstants):
    ...
    #       val19_t2 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val19_t3 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val19_t4 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       ...

    # prio19 OF RESOURCES OVER PARTICIPANTS =================================================== #
    #   Since this app models only the proposing side as active players, the prio19 of the      #
    ...
    # SHOW RESOURCES' prio19 ================================================================== #
    #   Should a player see the resources' prio19 for her in the instructions and on the        #
    #   decision page?                                                                              #
    show_prio19 = False
    ...
    val19_list = ["val19_t" + str(i) for i in range(1, 11)]
    val19_raw = []
    for i in val19_list:
        if i in locals():
            val19_raw.append(locals()[i])

    val19 = []
    for i in val19_raw:
        val19.append([j for j in i if j is not None])

    prio19_list = ["prio19_r" + str(i) for i in range(1, 11)]
    prio19_raw = []
    for i in prio19_list:
        if i in locals():
            prio19_raw.append(locals()[i])

    prio19 = []
    for i in prio19_raw:
        prio19.append([j for j in i if j is not None])

    nr_types = len(val19)

    name_in_url = "SHda19_adv"
    num_rounds = 1
