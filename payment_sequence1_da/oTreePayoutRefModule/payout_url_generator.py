# ------------------------------------------------------------------------------------------------#
#  Payout URL Generator --- To be used with oTree --- Tested using Python 3.10.6 (adjusted for Python 3.8)
# ------------------------------------------------------------------------------------------------#
...
class PayoutURLGenerator():
    ...
    def __init__(self, expShortName: str = None, expId: str = None,
                 sessId: str = None, pid: str = None, payout: float = 0, baseURL: str = DEFAULT_BASE_URL):
    ...
    def setSessId(self, sessId: str) -> None:
