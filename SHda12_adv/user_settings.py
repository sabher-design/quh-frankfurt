...
class Constants(BaseConstants):
    ...
    #       val12_t2 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val12_t3 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       val12_t4 = [85, 2, 2, 80, 50, 80, 80, 30, 80, 80]
    #       ...

    # prio12 OF RESOURCES OVER PARTICIPANTS =================================================== #
    #   Since this app models only the proposing side as active players, the prio12 of the      #
    ...
    # SHOW RESOURCES' prio12 ================================================================== #
    #   Should a player see the resources' prio12 for her in the instructions and on the        #
    #   decision page?                                                                              #
    show_prio12 = False
    ...
    val12_list = ["val12_t" + str(i) for i in range(1, 11)]
    val12_raw = []
    for i in val12_list:
        if i in locals():
            val12_raw.append(locals()[i])

    val12 = []
    for i in val12_raw:
        val12.append([j for j in i if j is not None])

    prio12_list = ["prio12_r" + str(i) for i in range(1, 11)]
    prio12_raw = []
    for i in prio12_list:
        if i in locals():
            prio12_raw.append(locals()[i])

    prio12 = []
    for i in prio12_raw:
        prio12.append([j for j in i if j is not None])

    nr_types = len(val12)

    name_in_url = "SHda12_adv"
    num_rounds = 1
