...
# =========================================================================================== #
print(f"val15 SHttc15_adv: {Constants.val15}")
print(f"prio15 SHttc15_adv: {Constants.prio15}")
...
def vars_for_all_templates(self):
    return {
        ...
        'val15': self.participant.vars['val15'],
        'val15_others': zip(self.participant.vars['other_types_names'],
                                 self.participant.vars['val15_others']),
        'prio15': self.participant.vars['prio15'],
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        success15 = [i for i in self.participant.vars['success15']]
