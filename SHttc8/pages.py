...
# =========================================================================================== #
print(f"val8 SHttc8: {Constants.val8}")
print(f"prio8 SHttc8: {Constants.prio8}")
...
class Results(Page):
    ...
    def before_next_page(self):
        ...
        self.participant.vars['SHttc8_payoff'] = "{:.0f}".format(base_payoff)
        self.participant.vars['SHttc8_payoff_half'] = "{:.2f}".format(half_payoff)
        self.participant.vars['SHttc8_payoff_final'] = "{:.2f}".format(final_payoff)
